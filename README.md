...
In each collision cycle, the radii of the waves gets halved, and there is half as much distance between the origin points of the waves that collided and the origin points generated from that collision. 
